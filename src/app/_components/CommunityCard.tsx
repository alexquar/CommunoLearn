...
const {community} = props;
  return (
    ...
    <Link href={`/communities/${community.id}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-secondaryBrand hover:bg-secondaryBrand/75  rounded-full ">
        Read more
